  ...
  return (
    <section className="relative flex items-center justify-center h-screen bg-[#121212] overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          <Button size="lg" className="bg-gradient-to-r from-[#6D4AFF] to-[#B668FF] text-white cursor-pointer transform transition-transform duration-200 hover:scale-105">
            Começar Agora <ArrowRight className="ml-2" />
          </Button>
          <Button size="lg" variant="outline" className="border-[#6D4AFF] text-[#6D4AFF] hover:bg-[#6D4AFF]/10 cursor-pointer transform transition-transform duration-200 hover:scale-105">
            Saiba Mais
          </Button>
        </motion.div>
      </div>
