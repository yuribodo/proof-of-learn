...
contract RoadmapNFT is ERC721URIStorage {
    ...
    event NFTMinted(address indexed to, uint256 indexed roadmapId, uint256 tokenId);

    constructor(address verifierAddress) ERC721("Roadmap Completion NFT", "RMNFT") {
    ...
    function mintWithProof(
        ...
        require(!hasMinted[msg.sender][roadmapId], "Already minted for this roadmap");
